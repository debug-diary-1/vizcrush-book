...
- [Picking the Right Tool](./ch12-picking-the-right-tool.md)
- [Using vizcrush: A Tour in Code](./ch13-using-vizcrush.md)

# Under the Hood

- [Why It Doesn't Break (Fallback Strategy)](./ch14-fallbacks.md)
- [Making It Fast (Performance Lessons)](./ch15-performance.md)
- [The Math Behind It All](./ch16-math.md)
