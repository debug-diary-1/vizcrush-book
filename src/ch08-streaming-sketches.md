...
Imagine you're collecting values in a bucket. When the bucket fills up, you can't keep everything, so you play a little game: sort what you have, then keep every _other_ element and throw the rest away. You pour the survivors into a _second_, bigger bucket. That bucket represents twice the information per slot, meaning each element now "stands in for" two of the originals.
