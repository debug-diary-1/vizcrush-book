...
If you want to fairly compare "how good is each student relative to their classmates," raw scores won't work: the tests weren't the same and the grading wasn't the same. What _does_ work is comparing _ranks_. "10th best" means the same thing in both classes, regardless of scale.
